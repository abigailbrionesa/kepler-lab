...
export const CameraControlProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  return (
    <CameraControlContext.Provider value={{ cameraControlsRef, rotate, zoom, dolly, truck, moveTo }}>
      {children}
