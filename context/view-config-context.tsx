...
export const ViewConfigContext = createContext<ViewConfigContextType>(defaultContext)

export const useViewConfig = () => useContext(ViewConfigContext)

export const ViewConfigProvider = ({ children }: { children: ReactNode }) => {
  const [viewConfig, setViewConfig] = useState<ViewConfigOptions>(defaultConfig)
  ...
  return (
    <ViewConfigContext.Provider value={{ viewConfig, toggleOption, resetConfig }}>
      {children}
